...
class YLC_OID_BASE{
  ...
  public function beginAuth($openid){
    ...
    if (!$auth_request) { $this->displayError("認證失敗"); }
  ...
  private function createTCaxs(){
    ...
    $attribute[] = Auth_OpenID_AX_AttrInfo::make('http://openid.edu.tw/axschema/school/id',1,1, 'schoolid');
    $attribute[] = Auth_OpenID_AX_AttrInfo::make('http://openid.ylc.edu.tw/schema/schooltown',1,1, 'schooltown');
    $attribute[] = Auth_OpenID_AX_AttrInfo::make('http://openid.ylc.edu.tw/schema/schoolname',1,1, 'schoolname');
    $attribute[] = Auth_OpenID_AX_AttrInfo::make('http://openid.ylc.edu.tw/schema/schooltype',1,1, 'schooltype');
    $attribute[] = Auth_OpenID_AX_AttrInfo::make('http://openid.ylc.edu.tw/schema/usertype',1,1, 'usertype');
    $attribute[] = Auth_OpenID_AX_AttrInfo::make('http://openid.ylc.edu.tw/schema/userjob',1,1, 'userjob');
    return $attribute;
  }
